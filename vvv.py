...
with st.sidebar:
    # 侧边栏显示图标
    st.image('https://i.natgeofe.com/n/365cab4b-7c9f-487a-a76d-0ec4cb6d433a/emperor-penguin_thumb_4x3.jpg', width=100)  
...
if page == "简介页面":
    ...
    st.header("三种企鹅的卡通图像")
    # 展示企鹅卡通图
    st.image('https://i.natgeofe.com/n/365cab4b-7c9f-487a-a76d-0ec4cb6d433a/emperor-penguin_thumb_4x3.jpg')  
...
# ------------------------- 4. 预测分类页面内容 -------------------------
    ...
    with col_logo:
        if not submitted:
            # 未提交时显示默认图标
            st.image('https://i.natgeofe.com/n/365cab4b-7c9f-487a-a76d-0ec4cb6d433a/emperor-penguin_thumb_4x3.jpg', width=300)
        else:
            # 提交后显示对应物种的图片
            st.image(
                f'{predict_result_species}.png', 
                width=300
            )
